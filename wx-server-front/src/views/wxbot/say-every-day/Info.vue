        ...
        <a-row :gutter="[15, 15]">
          ...
          <a-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            <a-form-item label="所在城市">
              <a-input
                v-model:value="state.vm.form.city"
                placeholder="请输入 所在城市"
              />
            </a-form-item>
          </a-col>
          <a-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            <a-form-item label="结尾备注">
              <a-input
          ...
          <a-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            <a-form-item label="纪念日">
              <a-date-picker
                ...
                style="width: 100%"
                v-model:value="state.vm.form.anniversaryDay"
              />
            </a-form-item>
          </a-col>
        </a-row>
...
const methods = {
  ...
  saveForm() {
    ...
    if (!state.vm.form.city) return tools.message("所在城市必填!", "警告");
    if (!state.vm.form.closingRemarks)
      return tools.message("结尾备注必填!", "警告");
