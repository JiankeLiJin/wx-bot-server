        ...
        <a-row :gutter="[15, 15]">
                ...
                <a-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                    <a-form-item label="所在城市">
                        <a-input v-model:value="state.vm.form.city" placeholder="请输入 所在城市" />
                    </a-form-item>
                </a-col>
                <a-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                    <a-form-item label="结尾备注">
                        <a-input v-model:value="state.vm.form.closingRemarks" placeholder="请输入 结尾备注" />
                    </a-form-item>
                </a-col>
                <a-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                    <a-form-item label="纪念日">
                        <a-input v-model:value="state.vm.form.anniversaryDay" placeholder="请输入 纪念日" />
                    </a-form-item>
                </a-col>
        </a-row>
      </a-form>
